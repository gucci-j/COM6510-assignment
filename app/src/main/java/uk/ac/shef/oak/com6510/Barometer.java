...
public class Barometer {
            ...
            mPressureListener = new SensorEventListener() {
                ...
                public void onSensorChanged(SensorEvent event) {
                    ...
                    if (diff >= mSamplingRateNano) {
                        ...
                        currentPressureValue = event.values[0];
                        int accuracy = event.accuracy;

                        Log.i(TAG, Utilities.mSecsToString(actualTimeInMseconds) + ": current barometric pressure: " + currentPressureValue + " with accuracy: " + accuracy);
    ...
    public float getCurrentPressureValue() {
